        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body">
            ...
            <hr class="mx-n3">
                   ...
                   <select class="form-select" aria-label="Default select example" name="id_entreprise">
                    <option selected>Entreprise</option>
                    <?php $req= $bdd->query("SELECT id,nom_entreprise FROM entreprise");
                      while($donnees=$req->fetch()){
                    ?>
                    <option value="<?php echo $donnees['id'];?>"><?php echo $donnees['nom_entreprise'];?></option>
                    <?php } ?>
                  </select>        
            <hr class="mx-n3">
